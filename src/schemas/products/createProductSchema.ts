...
export const CreateProductSchema = z.object({
	...
	product_category: z.object({
		id: z.string().min(1, { message: "El id de la categoría no puede estar vacío" }),
	...
	product_family: z.object({
		id: z.string().min(1, { message: "El id de la familia no puede estar vacío" }),
	...
	measurement_unit: z.object({
		id: z.string().min(1, { message: "El id de la unidad de medida no puede estar vacío" }),
